...
map.getView().fit([8339825.645428, 1302923.200883, 8480493.986880, 1385108.293695], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAP OF KANNUR</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (125 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS MAP SHOWS THE DETAILED INFORMATION OF KANNUR DISTRICT INCLUDING DRAINAGE, RAILWAY, ROAD NETWORK,GEOMORPHOLOGY,JUNCTIONS.';
            }
